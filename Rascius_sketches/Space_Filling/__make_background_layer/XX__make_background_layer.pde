...
int numberAttemptsToDrawLetter = 250;
...
void draw() {
  ...
  if (currentSize > minSize) {
    ...
    PGraphics pdf = createGraphics(width, height, PDF, "/Users/kylebebak/Desktop/Dropbox/Programming/Processing/Rascius sketches/Space Filling/output.pdf");
    pdf.beginDraw();
    pdf.image(get(), 0, 0);
    pdf.dispose();
    pdf.endDraw();
