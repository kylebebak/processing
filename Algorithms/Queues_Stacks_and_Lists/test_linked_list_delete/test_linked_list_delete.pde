...
void setup() {
  ...
  int N = 20000;
  for (int i = 0; i < N; i++) st.push((int)random(10*N));
...
public class Stack<Item> implements Iterable<Item> {
  ...
  // these are the implementations i want! elegant and readable. the bottom
  // one is ever so slightly faster than the first one, maybe 3%
