...
int startvalue=500; //number of chips of each color at the start or after a reset
...
void draw() {
  ...
  for (int c=0; c<iterations; c++) {
    ...
    for (int i=0; i<x.length; i++) {
      ...
      if ( !carry[i] && pg.get(xi, yi) != backgroundColor ) {
      ...
      if (carry[i]) {
        ...
        if ( pg.get(x10, yi) != backgroundColor ||
          pg.get(x11, yi) != backgroundColor ||
          pg.get(xi, y10) != backgroundColor ||
          pg.get(xi, y11) != backgroundColor ) {

          if ( pg.get(x20, yi) != backgroundColor ||
            pg.get(x22, yi) != backgroundColor ||
            pg.get(xi, y20) != backgroundColor ||
            pg.get(xi, y22) != backgroundColor || 
            pg.get(x10, y10) != backgroundColor ||
            pg.get(x11, y10) != backgroundColor ||
            pg.get(x10, y11) != backgroundColor ||
            pg.get(x11, y11) != backgroundColor ) { 

            if ( pg.get(x30, yi) != backgroundColor ||
              pg.get(x33, yi) != backgroundColor ||
              pg.get(xi, y30) != backgroundColor ||
              pg.get(xi, y33) != backgroundColor ||

              pg.get(x20, y10) != backgroundColor ||
              pg.get(x20, y11) != backgroundColor ||
              pg.get(x22, y10) != backgroundColor ||
              pg.get(x22, y11) != backgroundColor ||

              pg.get(x10, y20) != backgroundColor ||
              pg.get(x11, y20) != backgroundColor ||
              pg.get(x10, y22) != backgroundColor ||
              pg.get(x11, y22) != backgroundColor ) { 
